...
:::tip
The easiest way to launch an app on mobile is by selecting the Shapes button in the chat bar and selecting the app you would like to start. It then provides an interface for selecting preset commands for the app without having to type them out.
